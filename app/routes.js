...
router.get('/asset-23b', function (req, res) {
  res.render('assets/asset-23b')
})
router.get('/asset-24', function (req, res) {
  res.render('assets/asset-24')
})
router.get('/asset-24b', function (req, res) {
  res.render('assets/asset-24b')
})
...
router.get('/asset-27', function (req, res) {
  res.render('assets/asset-27')
})
router.get('/asset-28', function (req, res) {
  res.render('assets/asset-28')
})
router.get('/asset-29', function (req, res) {
  res.render('assets/asset-29')
})
router.get('/asset-29b', function (req, res) {
  res.render('assets/asset-29b')
})
// Icons
...
router.get('/api/places.geojson', (req, res) => {
  const places = require('./data/places-geojson.js')
  res.json(places)
})
router.get('/api/outlook.geojson', (req, res) => {
  const outlook = require('./data/outlook-geojson.js')
  res.json(outlook)
})
